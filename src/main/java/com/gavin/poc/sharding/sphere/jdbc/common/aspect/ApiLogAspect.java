package com.gavin.poc.sharding.sphere.jdbc.common.aspect;

import cn.hutool.core.thread.threadlocal.NamedThreadLocal;
import cn.hutool.core.util.IdUtil;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.gavin.poc.sharding.sphere.jdbc.common.util.IpUtil;
import com.gavin.poc.sharding.sphere.jdbc.common.util.TimeStampUtil;
...
public class ApiLogAspect {
    ...
    @Pointcut("execution(* com.yoona.sharding.*..controller.*..*(..))")
    public void apiLog() {
    }
